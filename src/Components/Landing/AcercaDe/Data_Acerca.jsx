    ...
    return (
        <div className="div-body-container">
            ...
            <div className="div-infEmpresa">
                ...
                <h4>Visión</h4>
                <p>Ser líderes en tecnologías avanzadas que previenen riesgos en laboratorios, reconocidos como colaboradores confiables en la protección de vidas y del medio ambiente a nivel global.</p>
            </div>
